...
from comment.grpc.notification_pb2 import SendNotificationRequest, SendBulkNotificationRequest
from comment.grpc.notification_pb2_grpc import NotificationServiceStub
