...
from community.grpc.notification_pb2 import SendNotificationRequest, SendBulkNotificationRequest
from community.grpc.notification_pb2_grpc import NotificationServiceStub
